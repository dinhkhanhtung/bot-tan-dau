...
export async function handleDefaultMessage(user: any) {
    ...
    await sendMessagesWithTyping(user.facebook_id, [
        'Chào mừng bạn ghé thăm Đinh Khánh Tùng:',
        'Hôm nay mình có thể giúp gì cho bạn',
        'Có thể bạn cũng muốn tham gia cộng đồng Tân Dậu - Hỗ Trợ Chéo, Nơi Tân Dậu cùng nhau kết nối - cùng nhau thịnh vượng. Bạn có thể...',
